...
var BuiltInFunctions = []BuiltInFunction{
	...
	},
	{
		...
		Description: "For more information, see [`RANGE_SESSIONIZE`](/bigquery/docs/reference/standard-sql/range-functions#range_sessionize) in\nRange functions.",
		ExampleSQLs: []string{},
	...
	},
	{
		...
		Method:      "For more information, see RANGE_SESSIONIZE in\nRange functions.",
		Description: "",
		ExampleSQLs: []string{},
		URL:         "https://cloud.google.com/bigquery/docs/reference/standard-sql/table-functions-built-in#range_sessionize",
	},
	{
		Name:        "CAST",
	...
	{
		Name:        "EDIT_DISTANCE",
		Method:      "EDIT_DISTANCE(value1, value2, [max_distance => max_distance_value])",
