...
func (h *Handler) handleTextDocumentFormatting(ctx context.Context, conn *jsonrpc2.Conn, req *jsonrpc2.Request) (result any, err error) {
	if req.Params == nil {
	...
	rawText, ok := h.project.GetFile(params.TextDocument.URI)
	if !ok {
